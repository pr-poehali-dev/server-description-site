    ...
    <div className="min-h-screen font-minecraft" style={{ background: "#0a0c0f", color: "#e8e0d0", fontSize: "18px" }}>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto pt-20">
          ...
          <p className="max-w-xl mx-auto mb-10 leading-relaxed text-2xl font-medium" style={{ color: "#8a7a6a" }}></p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#about"
              className="font-politburo tracking-wider transition-all duration-200 px-[18px] my-[3px] mx-0 py-[19px] text-xl rounded-xl font-normal"
              style={{ background: "linear-gradient(135deg, #c9a84c, #a07830)", color: "#0a0c0f" }}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 rounded-xl font-politburo tracking-wider text-xl transition-all duration-200"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {TEAM.map((m) => (
              ...
              >
                ...
                <div className="font-pixel my-[13px] mx-0 px-0 py-[5px] rounded-xl" style={{ fontSize: "0.5rem", color: "#c9a84c" }}>{m.role}</div>
